/* ============================================================
   BOSS SPRITES — animated pixel-art SVGs keyed by boss id.
   Each entry contains TWO frames; CSS alternates them for idle animation.
   Wrapped at render time in <div class="boss-portrait">.
   ============================================================ */
(function () {
  function pair(frame1, frame2) {
    return `<div class="frame frame-1">${frame1}</div><div class="frame frame-2">${frame2}</div>`;
  }
  ...
  const sprites = {
    ...
    copd: pair(
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        <rect x="6" y="1" width="4" height="3" fill="#6a8caa"/>
        <rect x="7" y="2" width="2" height="1" fill="#3a5070"/>
        <rect x="9" y="2" width="1" height="1" fill="#3a5070"/>
        <rect x="7" y="3" width="2" height="1" fill="#3a5070"/>
        <rect x="3" y="4" width="10" height="7" fill="#4a78a8"/>
        <rect x="4" y="5" width="2" height="2" fill="#6aa0d0"/>
        <rect x="10" y="5" width="2" height="2" fill="#6aa0d0"/>
        ...
        <rect x="5" y="14" width="2" height="2" fill="#1a2030"/>
        <rect x="9" y="14" width="2" height="2" fill="#1a2030"/>
        <rect x="1" y="0" width="2" height="1" fill="#888888aa"/>
        <rect x="2" y="1" width="2" height="1" fill="#aaaaaaaa"/>
        <rect x="12" y="1" width="3" height="1" fill="#888888aa"/>
        <rect x="13" y="2" width="2" height="1" fill="#aaaaaaaa"/>
      </svg>`
    ),

    // ASTHMA — lightning sparks twitch position
    asthma: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="12" y="3" width="1" height="1" fill="#ff8080"/>
        <rect x="2" y="0" width="1" height="2" fill="#ffcc00"/>
        <rect x="1" y="2" width="2" height="1" fill="#ffcc00"/>
        <rect x="13" y="0" width="1" height="2" fill="#ffcc00"/>
        <rect x="13" y="2" width="2" height="1" fill="#ffcc00"/>
        <rect x="0" y="9" width="2" height="1" fill="#ff8000"/>
        <rect x="14" y="9" width="2" height="1" fill="#ff8000"/>
        <rect x="6" y="14" width="1" height="2" fill="#ff8000"/>
        <rect x="9" y="14" width="1" height="2" fill="#ff8000"/>
        <rect x="7" y="11" width="2" height="1" fill="#ffffff88"/>
      </svg>`
    ),

    // ABG — ghost bobs up/down
    abg: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        <rect x="5" y="2" width="6" height="1" fill="#40c060"/>
        <rect x="4" y="3" width="4" height="10" fill="#40c060"/>
        <rect x="8" y="3" width="4" height="10" fill="#3080d0"/>
        <rect x="3" y="4" width="1" height="8" fill="#40c060"/>
        <rect x="12" y="4" width="1" height="8" fill="#3080d0"/>
        <rect x="5" y="3" width="3" height="1" fill="#80e0a0"/>
        <rect x="8" y="3" width="3" height="1" fill="#70b0e0"/>
        ...
        <rect x="3" y="13" width="2" height="1" fill="#40c06088"/>
        <rect x="7" y="13" width="2" height="1" fill="#60a09888"/>
        <rect x="11" y="13" width="2" height="1" fill="#3080d088"/>
        <rect x="4" y="14" width="1" height="1" fill="#40c06088"/>
        <rect x="11" y="14" width="2" height="1" fill="#3080d088"/>
        <rect x="7" y="15" width="2" height="1" fill="#60a09888"/>
      </svg>`
    ),

    // PLEURAL — air bubble drifts
    pleural: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="5" y="2" width="1" height="1" fill="#d04040"/>
        <rect x="10" y="2" width="1" height="1" fill="#d04040"/>
        <rect x="13" y="6" width="2" height="1" fill="#e0e0f0"/>
        <rect x="14" y="5" width="1" height="2" fill="#e0e0f088"/>
        <rect x="15" y="4" width="1" height="1" fill="#e0e0f088"/>
      </svg>`
    ),

    // INFECTIOUS — germ spots shimmer
    infectious: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="5" y="6" width="2" height="2" fill="#ffffff"/>
        <rect x="9" y="6" width="2" height="2" fill="#ffffff"/>
        <rect x="5" y="7" width="1" height="1" fill="#1a2030"/>
        <rect x="10" y="7" width="1" height="1" fill="#1a2030"/>
        <rect x="6" y="10" width="4" height="1" fill="#1a2030"/>
        <rect x="7" y="11" width="2" height="2" fill="#d04040"/>
        <rect x="6" y="5" width="1" height="1" fill="#ffd84088"/>
        <rect x="9" y="9" width="1" height="1" fill="#ffd84088"/>
        <rect x="5" y="9" width="1" height="1" fill="#ffd84088"/>
        <rect x="10" y="6" width="1" height="1" fill="#ffd84088"/>
        <rect x="2" y="13" width="3" height="2" fill="#70a020"/>
        <rect x="11" y="13" width="3" height="2" fill="#70a020"/>
      </svg>`
    ),
    ...
    ards: pair(
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        <rect x="1" y="1" width="3" height="3" fill="#6040a0"/>
        <rect x="7" y="2" width="3" height="3" fill="#6040a0"/>
        <rect x="12" y="1" width="3" height="3" fill="#6040a0"/>
        <rect x="2" y="2" width="1" height="1" fill="#ffffff"/>
        <rect x="8" y="3" width="1" height="1" fill="#ffffff"/>
        <rect x="13" y="2" width="1" height="1" fill="#ffffff"/>
        <rect x="1" y="4" width="3" height="1" fill="#6040a0"/>
        <rect x="7" y="5" width="3" height="1" fill="#6040a0"/>
        <rect x="12" y="4" width="3" height="1" fill="#6040a0"/>
        <rect x="2" y="5" width="2" height="2" fill="#4080d0"/>
        <rect x="7" y="6" width="3" height="2" fill="#4080d0"/>
        <rect x="12" y="5" width="2" height="2" fill="#4080d0"/>
        <rect x="3" y="8" width="10" height="5" fill="#4080d0"/>
        <rect x="3" y="9" width="10" height="1" fill="#80c0e0"/>
        <rect x="5" y="10" width="2" height="2" fill="#6040a0"/>
        <rect x="9" y="10" width="2" height="2" fill="#6040a0"/>
        <rect x="4" y="13" width="8" height="1" fill="#4080d0"/>
        <rect x="5" y="14" width="6" height="1" fill="#3060a0"/>
        <rect x="4" y="9" width="1" height="1" fill="#ffffff88"/>
        <rect x="11" y="9" width="1" height="1" fill="#ffffff88"/>
      </svg>`
    ),

    // ILD — honeycomb highlights twinkle
    ild: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        <rect x="6" y="1" width="4" height="3" fill="#a07040"/>
        <rect x="7" y="2" width="1" height="1" fill="#604020"/>
        <rect x="9" y="2" width="1" height="1" fill="#604020"/>
        <rect x="7" y="3" width="2" height="1" fill="#604020"/>
        <rect x="4" y="4" width="8" height="9" fill="#806040"/>
        <rect x="5" y="5" width="2" height="1" fill="#403020"/>
        <rect x="9" y="5" width="2" height="1" fill="#403020"/>
        <rect x="5" y="6" width="1" height="1" fill="#a08060"/>
        <rect x="10" y="6" width="1" height="1" fill="#a08060"/>
        <rect x="5" y="7" width="2" height="1" fill="#403020"/>
        <rect x="9" y="7" width="2" height="1" fill="#403020"/>
        <rect x="7" y="7" width="2" height="1" fill="#403020"/>
        <rect x="7" y="8" width="1" height="1" fill="#a08060"/>
        <rect x="10" y="8" width="1" height="1" fill="#a08060"/>
        <rect x="5" y="9" width="2" height="1" fill="#403020"/>
        <rect x="9" y="9" width="2" height="1" fill="#403020"/>
        <rect x="7" y="9" width="2" height="1" fill="#403020"/>
        <rect x="5" y="10" width="1" height="1" fill="#a08060"/>
        <rect x="10" y="10" width="1" height="1" fill="#a08060"/>
        <rect x="5" y="11" width="2" height="1" fill="#403020"/>
        <rect x="9" y="11" width="2" height="1" fill="#403020"/>
        <rect x="3" y="13" width="3" height="3" fill="#604020"/>
        <rect x="10" y="13" width="3" height="3" fill="#604020"/>
    ...
    sleep: pair(
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="2" y="5" width="1" height="6" fill="#3020a0"/>
        <rect x="13" y="5" width="1" height="6" fill="#3020a0"/>
        <rect x="5" y="6" width="2" height="1" fill="#604080"/>
        <rect x="9" y="6" width="2" height="1" fill="#604080"/>
        <rect x="5" y="7" width="2" height="1" fill="#604080"/>
        <rect x="9" y="7" width="2" height="1" fill="#604080"/>
        <rect x="6" y="10" width="4" height="1" fill="#1a1030"/>
        <rect x="3" y="12" width="2" height="1" fill="#3020a0"/>
        ...
        <rect x="2" y="13" width="12" height="2" fill="#604080"/>
        <rect x="1" y="14" width="14" height="2" fill="#806090"/>
        <rect x="12" y="0" width="2" height="1" fill="#80c0ff"/>
        <rect x="13" y="1" width="1" height="1" fill="#80c0ff"/>
        <rect x="14" y="2" width="1" height="1" fill="#80c0ff"/>
        <rect x="13" y="3" width="2" height="1" fill="#80c0ff"/>
        <rect x="14" y="5" width="1" height="1" fill="#80c0ff88"/>
      </svg>`
    ),

    // NEURO — limbs droop further
    neuro: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="7" y="3" width="2" height="1" fill="#608040"/>
        <rect x="5" y="4" width="6" height="6" fill="#a0b070"/>
        <rect x="4" y="6" width="1" height="3" fill="#a0b070"/>
        <rect x="11" y="6" width="1" height="3" fill="#a0b070"/>
        <rect x="3" y="9" width="1" height="3" fill="#a0b07088"/>
        <rect x="12" y="9" width="1" height="3" fill="#a0b07088"/>
        <rect x="2" y="12" width="1" height="2" fill="#a0b07055"/>
        <rect x="13" y="12" width="1" height="2" fill="#a0b07055"/>
        <rect x="6" y="10" width="4" height="3" fill="#a0b070"/>
        <rect x="5" y="13" width="2" height="2" fill="#a0b07088"/>
        <rect x="9" y="13" width="2" height="2" fill="#a0b07088"/>
        <rect x="6" y="15" width="1" height="1" fill="#a0b07055"/>
        <rect x="9" y="15" width="1" height="1" fill="#a0b07055"/>
        <rect x="1" y="6" width="1" height="1" fill="#608040"/>
        <rect x="3" y="7" width="1" height="1" fill="#608040"/>
        <rect x="14" y="6" width="1" height="1" fill="#608040"/>
        <rect x="14" y="9" width="1" height="1" fill="#608040"/>
        <rect x="2" y="14" width="1" height="1" fill="#608040"/>
      </svg>`
    ),
    ...
    pvd: pair(
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="0" y="11" width="2" height="5" fill="#3080d0"/>
        <rect x="14" y="11" width="2" height="5" fill="#3080d0"/>
        <rect x="1" y="7" width="1" height="1" fill="#80c0e0"/>
        <rect x="14" y="8" width="1" height="1" fill="#80c0e0"/>
        <rect x="6" y="4" width="1" height="1" fill="#80c0e0"/>
        <rect x="8" y="7" width="2" height="2" fill="#1a1010"/>
      </svg>`
    ),
  };
...
/* ============================================================
   RCP 104 BOSS SPRITES — pharmacology (animated)
   ============================================================ */
(function () {
  function pair(frame1, frame2) {
    return `<div class="frame frame-1">${frame1}</div><div class="frame frame-2">${frame2}</div>`;
  ...
  const sprites = {
    // CORTICOSTEROIDS — eyes blink
    corticosteroids: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="6" y="10" width="4" height="1" fill="#1a1010"/>
        <rect x="7" y="11" width="2" height="1" fill="#1a1010"/>
      </svg>`
    ),

    // NONSTEROIDAL — sparks twitch, mouth widens
    nonsteroidal: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="6" y="7" width="4" height="1" fill="#a05000"/>
        <rect x="3" y="14" width="2" height="2" fill="#1a1010"/>
        <rect x="11" y="14" width="2" height="2" fill="#1a1010"/>
      </svg>`
    ),

    // ANTIINFECTIVE — drip particles shift
    antiinfective: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="6" y="10" width="4" height="1" fill="#80a0a8"/>
        <rect x="4" y="11" width="6" height="1" fill="#a0d0d8aa"/>
        <rect x="2" y="12" width="3" height="1" fill="#a0d0d8aa"/>
        <rect x="11" y="12" width="3" height="1" fill="#a0d0d8aa"/>
        <rect x="0" y="13" width="4" height="1" fill="#c0e0e8aa"/>
        <rect x="12" y="13" width="4" height="1" fill="#c0e0e8aa"/>
        <rect x="1" y="14" width="6" height="1" fill="#e0f0f8aa"/>
        <rect x="11" y="14" width="6" height="1" fill="#e0f0f8aa"/>
        <rect x="3" y="15" width="3" height="1" fill="#e0f0f8aa"/>
        <rect x="10" y="15" width="3" height="1" fill="#e0f0f8aa"/>
      </svg>`
    ),

    // ANTIMICROBIAL — vial bubble rises
    antimicrobial: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="12" y="6" width="1" height="6" fill="#c0c0d0"/>
        <rect x="13" y="5" width="1" height="2" fill="#c0c0d0"/>
        <rect x="13" y="6" width="1" height="3" fill="#80e0f0"/>
        <rect x="12" y="4" width="2" height="1" fill="#a0a0b0"/>
        <rect x="2" y="7" width="3" height="5" fill="#707078"/>
        <rect x="1" y="8" width="1" height="3" fill="#707078"/>
        <rect x="3" y="9" width="1" height="1" fill="#1a1010"/>
        <rect x="2" y="8" width="1" height="1" fill="#1a1010"/>
        <rect x="2" y="10" width="1" height="1" fill="#1a1010"/>
        <rect x="4" y="12" width="3" height="3" fill="#a0a0b0"/>
        <rect x="9" y="12" width="3" height="3" fill="#a0a0b0"/>
      </svg>`
    ),

    // COLD-COUGH — tissue waves, drips shift
    'cold-cough': pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="3" y="13" width="10" height="3" fill="#ffffff"/>
        <rect x="2" y="14" width="12" height="1" fill="#ffffff"/>
        <rect x="4" y="13" width="2" height="1" fill="#80c0e0"/>
        <rect x="10" y="13" width="2" height="1" fill="#80c0e0"/>
        <rect x="2" y="2" width="2" height="2" fill="#60a0e0aa"/>
        <rect x="12" y="2" width="2" height="2" fill="#60a0e0aa"/>
        <rect x="7" y="13" width="1" height="2" fill="#80c0e0"/>
        <rect x="9" y="13" width="1" height="1" fill="#80c0e0"/>
      </svg>`
    ),

    // EMPHYSEMA-NO — smoke puffs drift
    'emphysema-no': pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="2" y="13" width="5" height="1" fill="#302020"/>
        <rect x="9" y="13" width="5" height="1" fill="#302020"/>
        <rect x="5" y="8" width="1" height="1" fill="#1a1010"/>
        <rect x="12" y="8" width="1" height="1" fill="#1a1010"/>
        <rect x="3" y="10" width="1" height="1" fill="#1a1010"/>
        <rect x="11" y="10" width="1" height="1" fill="#1a1010"/>
        <rect x="6" y="14" width="1" height="2" fill="#e8e0d0"/>
        <rect x="7" y="14" width="3" height="2" fill="#e8e0d0"/>
        <rect x="10" y="14" width="1" height="2" fill="#a04040"/>
        <rect x="10" y="13" width="1" height="1" fill="#f0c040"/>
        <rect x="11" y="15" width="2" height="1" fill="#80808080"/>
        <rect x="3" y="0" width="2" height="2" fill="#3080d0"/>
        <rect x="6" y="1" width="2" height="2" fill="#3080d0"/>
        <rect x="3" y="0" width="1" height="1" fill="#80c0f0"/>
        <rect x="6" y="1" width="1" height="1" fill="#80c0f0"/>
        <rect x="5" y="1" width="1" height="1" fill="#a0d0f0"/>
      </svg>`
    ),

    // NMBA — eyes droop further
    nmba: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="5" y="3" width="6" height="3" fill="#c09060"/>
        <rect x="5" y="3" width="6" height="1" fill="#d0a070"/>
        <rect x="6" y="4" width="1" height="1" fill="#603020"/>
        <rect x="9" y="4" width="1" height="1" fill="#603020"/>
        <rect x="6" y="5" width="4" height="1" fill="#603020"/>
        <rect x="6" y="6" width="4" height="4" fill="#b08050"/>
        <rect x="6" y="6" width="4" height="1" fill="#c09060"/>
        <rect x="3" y="8" width="3" height="1" fill="#b08050"/>
        <rect x="10" y="8" width="3" height="1" fill="#b08050"/>
        <rect x="2" y="9" width="1" height="2" fill="#b08050"/>
        <rect x="13" y="9" width="1" height="2" fill="#b08050"/>
        <rect x="6" y="10" width="1" height="4" fill="#a07040"/>
        <rect x="9" y="10" width="1" height="4" fill="#a07040"/>
        <rect x="5" y="14" width="2" height="2" fill="#a07040"/>
        <rect x="9" y="14" width="2" height="2" fill="#a07040"/>
    ...
    diuretics: pair(
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="2" y="10" width="1" height="2" fill="#3080d0"/>
        <rect x="13" y="10" width="1" height="2" fill="#3080d0"/>
        <rect x="2" y="7" width="1" height="1" fill="#3080d0"/>
        <rect x="13" y="7" width="1" height="1" fill="#3080d0"/>
        <rect x="1" y="12" width="1" height="2" fill="#3080d0"/>
        <rect x="14" y="12" width="1" height="2" fill="#3080d0"/>
        <rect x="1" y="14" width="1" height="1" fill="#f0d040"/>
        <rect x="14" y="14" width="1" height="1" fill="#f0d040"/>
        <rect x="2" y="15" width="1" height="1" fill="#f0d040"/>
        <rect x="13" y="15" width="1" height="1" fill="#f0d040"/>
        <rect x="6" y="10" width="4" height="1" fill="#603020"/>
      </svg>`
    ),

    // CNS-DRUGS — brain folds shift, eyes blink
    'cns-drugs': pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="4" y="13" width="8" height="1" fill="#a06090"/>
        <rect x="8" y="4" width="1" height="8" fill="#a06090"/>
        <rect x="4" y="5" width="2" height="1" fill="#a06090"/>
        <rect x="7" y="5" width="1" height="1" fill="#a06090"/>
        <rect x="11" y="5" width="2" height="1" fill="#a06090"/>
        <rect x="3" y="7" width="1" height="1" fill="#a06090"/>
        <rect x="6" y="7" width="2" height="1" fill="#a06090"/>
        <rect x="9" y="7" width="1" height="1" fill="#a06090"/>
        <rect x="12" y="7" width="1" height="1" fill="#a06090"/>
        <rect x="4" y="9" width="2" height="1" fill="#a06090"/>
        <rect x="7" y="9" width="1" height="1" fill="#a06090"/>
        <rect x="11" y="9" width="2" height="1" fill="#a06090"/>
        <rect x="3" y="11" width="1" height="1" fill="#a06090"/>
        <rect x="12" y="11" width="1" height="1" fill="#a06090"/>
        <rect x="5" y="7" width="2" height="1" fill="#1a1010"/>
        <rect x="9" y="7" width="2" height="1" fill="#1a1010"/>
        <rect x="13" y="1" width="2" height="2" fill="#604080"/>
        <rect x="12" y="0" width="2" height="1" fill="#604080"/>
      </svg>`
    ),

    // VASOPRESSORS — sparkle highlights shift
    vasopressors: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        <rect x="1" y="1" width="2" height="2" fill="#f0d040"/>
        <rect x="3" y="2" width="1" height="2" fill="#f0d040"/>
        <rect x="2" y="4" width="2" height="1" fill="#f0d040"/>
        <rect x="4" y="4" width="1" height="2" fill="#f0d040"/>
        <rect x="13" y="1" width="2" height="2" fill="#f0d040"/>
        <rect x="12" y="2" width="1" height="2" fill="#f0d040"/>
        <rect x="11" y="4" width="2" height="1" fill="#f0d040"/>
        <rect x="11" y="4" width="1" height="2" fill="#f0d040"/>
        <rect x="3" y="6" width="3" height="1" fill="#e04040"/>
        <rect x="10" y="6" width="3" height="1" fill="#e04040"/>
        <rect x="2" y="7" width="5" height="3" fill="#e04040"/>
        <rect x="9" y="7" width="5" height="3" fill="#e04040"/>
        ...
        <rect x="5" y="14" width="6" height="1" fill="#e04040"/>
        <rect x="6" y="15" width="4" height="1" fill="#e04040"/>
        <rect x="4" y="7" width="2" height="1" fill="#ff8080"/>
        <rect x="11" y="7" width="2" height="1" fill="#ff8080"/>
        <rect x="3" y="11" width="10" height="1" fill="#a02020"/>
    ...
    // ANTIHYPERTENSIVES — monitor blip pulses
    antihypertensives: pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="6" y="7" width="1" height="1" fill="#ffffff"/>
        <rect x="10" y="7" width="1" height="1" fill="#ffffff"/>
        <rect x="6" y="9" width="4" height="1" fill="#404040"/>
        <rect x="10" y="12" width="4" height="4" fill="#c0c0d0"/>
        <rect x="10" y="12" width="4" height="1" fill="#e0e0f0"/>
        <rect x="10" y="15" width="4" height="1" fill="#808088"/>
        <rect x="11" y="13" width="2" height="2" fill="#f0f0f8"/>
        <rect x="11" y="13" width="1" height="2" fill="#e04040"/>
        <rect x="12" y="14" width="1" height="1" fill="#808088"/>
        <rect x="2" y="12" width="1" height="3" fill="#1a1a1a"/>
        <rect x="3" y="14" width="1" height="2" fill="#1a1a1a"/>
        <rect x="4" y="15" width="2" height="1" fill="#1a1a1a"/>
        <rect x="0" y="8" width="1" height="2" fill="#606068"/>
        <rect x="15" y="8" width="1" height="2" fill="#606068"/>
      </svg>`
    ),

    // SLEEP-PHARM — sun/moon orbits, eye blinks
    'sleep-pharm': pair(
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
      ...
      `<svg viewBox="0 0 16 16" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="6" y="6" width="4" height="1" fill="#1a1a1a"/>
        <rect x="10" y="6" width="2" height="6" fill="#1a1a1a"/>
        <rect x="4" y="9" width="1" height="1" fill="#1a1010"/>
        <rect x="3" y="11" width="2" height="1" fill="#603020"/>
        <rect x="9" y="3" width="2" height="1" fill="#806090"/>
        <rect x="2" y="12" width="8" height="1" fill="#c0b060"/>
        <rect x="12" y="0" width="3" height="1" fill="#f0e890"/>
        <rect x="14" y="1" width="1" height="2" fill="#f0e890"/>
        <rect x="12" y="2" width="3" height="1" fill="#f0e890"/>
        <rect x="14" y="4" width="2" height="1" fill="#f0e890"/>
        <rect x="15" y="5" width="1" height="2" fill="#f0e890"/>
        <rect x="14" y="7" width="2" height="1" fill="#f0e890"/>
      </svg>`
    ),
  };
  window.BOSS_SPRITES = Object.assign(window.BOSS_SPRITES || {}, sprites);
